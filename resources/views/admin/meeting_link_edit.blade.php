                ...
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Update Meeting Link</div>
                        </div>
                        <div class="card-body">
                           <form action="{{route('meeting.link.update', $meeting->id)}}" method="post">
                            @csrf
                            <div class="form-group">
                                <select class="form-control" name="course_id">
                                    <option value="">Select Course Title</option>
                                    @foreach($courses as $course)
                                    <option value="{{$course->id}}" {{$course->id == $meeting->course_id ? "selected" : " "}}>{{$course->title}}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="email2" value="{{$meeting->meeting_title}}" required name="meeting_title" placeholder="Enter Meeting Title">
                           ...
                           <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="email2" value="{{$meeting->link}}" required name="link" placeholder="Enter Meeting Link">
                                <small style="color:red; font-weight:500">
                                @error('link')
                                {{$message}}
                                @enderror
