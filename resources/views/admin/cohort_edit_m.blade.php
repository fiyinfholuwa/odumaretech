                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Edit Cohort With Price</div>
                        </div>
                        <div class="card-body">
                           <form action="{{route('cohort_m.update', $cohort->id)}}" method="post">
                               ...
                               <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="email2" required value="{{$cohort->price}}" name="price" placeholder="Enter Course cohort Price">
                           ...
                           <div class="form-group">
                                ...
                                <select required class="form-control" name="course_id">
                                    ...
                                    <option value="{{$course->id}}" {{$course->id == $cohort->course_id ? "selected" : ""}}>{{$course->title}}</option>
                                    @endforeach
                                </select>
                                <small style="color:red; font-weight:500">
                                @error('course_id')
                            ...
                            <div class="form-group">
                                ...
                                <select required class="form-control" name="cohort_id">
                                    ...
                                    <option value="{{$cohort_c->id}}" {{$cohort_c->id == $cohort->cohort_id ? "selected" : ""}}>{{$cohort_c->name}}</option>
                                    @endforeach
                                </select>
                                <small style="color:red; font-weight:500">
                                @error('cohort_id')
                        ...
                        <div class="card-action">
                            <button class="btn btn-primary">Update cohort with Price</button>
