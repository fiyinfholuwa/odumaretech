...
<div class="modal-body">Are you sure you want to complete your payment, this action will take you to a payment gateway where you pay the remaining Installmental</div>
<div class="modal-footer">
    <input name="payment" type="hidden" value="paystack" /> 
