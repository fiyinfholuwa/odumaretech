						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Review All Projects</h4>
								</div>
								<div class="card-body">
										...
										<table id="basic-datatables" class="display table table-striped table-hover" >
											...
											<tr>
                                                ...
                                                <td>@if($assignment->status == "graded")
                                                    <span class="btn btn-danger btn-sm">Project Graded</span>
                                                    @else
                                                    <a href="{{route('project.submitted.to', $assignment->id)}}"  class="btn btn-secondary btn-sm">Grade Project</a>
                                                    @endif
                                                </td>
											</tr>
