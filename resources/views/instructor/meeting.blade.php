                ...
                <div class="col-md-10">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">View Meeting Link</div>
                        </div>
                        ...
                        <div class="card-body">
                                ...
                                <!-- <label for="email2">Github Link</label> -->
                                                <input type="text" id="text-input" class="form-control text-input" readonly  value="{{$meeting != null ? $meeting->link : 'No Meeting Session link provided yet'}}">
    ...
    <script>
        ...
        copyButtons.forEach((button, index) => {
            button.addEventListener("click", () => {
                ...
                showErrorMessage("Meeting link has been copied");
            });
        });
