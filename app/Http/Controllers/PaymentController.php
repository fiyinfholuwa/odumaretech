...
class PaymentController extends Controller
{
    ...
    //     // $actual_cost_from_cohort = CohortCourse::where('course_id', '=', $request->course_id)->where('cohort_id', '=', $request->cohort_id)->first();
    //     // $actual_cost_from_cohort_price = $actual_cost_from_cohort->price;

    //     // if( $actual_cost_from_cohort_price > $actual_cost_from_course){
    //     //     $actual_cost = $actual_cost_from_cohort_price;
    //     // }else{
    //     //     $actual_cost = $actual_cost_from_cohort_price;
    //     // }
